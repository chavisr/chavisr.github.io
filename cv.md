# Chavis Rujichan's CV

- Phone: +66 86 798 1272
- Email: [chavis.rujichan@gmail.com](mailto:chavis.rujichan@gmail.com)
- LinkedIn: [chavisr](https://linkedin.com/in/chavisr)
- GitHub: [chavisr](https://github.com/chavisr)
...
- CI\/CD: Experienced in implementing GitOps with #strong[`GitLab CI`] and #strong[`FluxCD`], with additional in #strong[`Jenkins`] and #strong[`ArgoCD`]

- Containerization: Skilled in container technologies including #strong[`Kubernetes`] and #strong[`Docker`] for scalable deployment

- Infrastructure as Code (IaC): Proficient in Infrastructure as Code using #strong[`Terraform`] and #strong[`Ansible`]

- Observability & Monitoring: Familiar with #strong[`ELK`] stack, #strong[`Prometheus`], and #strong[`Grafana`] for log management

- Workflow Orchestration: Experience working with #strong[`ArgoWorkflows`] and #strong[`Airflow`]

- Machine Learning: Leveraged #strong[`Kubeflow`] and #strong[`MLflow`] for end-to-end machine learning workflow

- Languages: English (IELTS: 6.0, TOEIC: 795), Thai (native)
...
## **Devops Engineer \/ Machine Learning Engineer**, Visai AI
...
## **Machine Learning Engineer**, Technimal
...
## **KMITL**, Bachelor in Electronics EngineeringMay 2017 – May 2021
...
## **Bacteria Classification using Image Processing and DCNN**

Nov 2019

#strong[#emph[Chavis Rujichan]], Narate Vongserewattana, Pattarapong Phasukkit

[10.1109/BMEiCON47515.2019.8990270](https://doi.org/10.1109/BMEiCON47515.2019.8990270)
